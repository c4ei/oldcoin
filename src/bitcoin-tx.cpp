...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s miningTT-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  miningTT-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded miningTT transaction") + "\n" +
              "  miningTT-tx [options] -create [commands]   " + _("Create hex-encoded miningTT transaction") + "\n" +
              "\n";
