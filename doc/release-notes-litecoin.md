MiningTT Core version *0.15.1* is now available from:

  <https://download.miningTT.org/miningTT-0.15.1/>
...
A number of changes to the way MiningTT Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 mgtts per kB (0.00001 MGTT). This is to prepare for dropping the minimum transaction fee to 0.1 mgtts per kB (0.0001 MGTT) in the next release.
