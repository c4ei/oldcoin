...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/miningTT-project/miningTT>";
    const std::string URL_WEBSITE = "<https://miningTT.org>";
