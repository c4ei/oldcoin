...
const char * const BITCOIN_CONF_FILENAME = "miningTT.conf";
const char * const BITCOIN_PID_FILENAME = "miningTT.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MiningTT";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MiningTT";
#else
    // Unix
    return pathRet / ".miningTT";
#endif
#endif
}
