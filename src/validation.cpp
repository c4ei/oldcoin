...
#if defined(NDEBUG)
# error "MiningTT cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MiningTT Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MGTT additional fees, %d delta bytes\n",
