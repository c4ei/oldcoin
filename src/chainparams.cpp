...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.miningTT.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.miningTTtools.com", true);
        vSeeds.emplace_back("dnsseed.miningTTpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.miningTTtools.com", true);
        vSeeds.emplace_back("seed-b.miningTT.loshan.co.uk", true);
